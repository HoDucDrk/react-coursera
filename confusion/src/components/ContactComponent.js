          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            <FormGroup row>
              ...
              <Col md={10}>
                ...
                invalid={errors.lastname !== ''} onChange={this.handleInputChange}></Input>
                <FormFeedback>
                  {errors.lastname}
                </FormFeedback>
              </Col>
            ...
            <FormGroup row>
              ...
              <Col md={10}>
                <Input type="text" id="telnum" name="telnum" placeholder="Contact Tel." value={this.state.telnum} 
                                valid={errors.telnum === ''}
            ...
            <FormGroup row>
              ...
              <Col md={10}>
                <Input type="textarea" id="message" name="message" rows="12" placeholder="Feedback" value={this.state.message} onChange={this.handleInputChange}></Input>
              </Col>
            </FormGroup>
            <FormGroup row>
