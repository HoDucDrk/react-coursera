        ...
        <div className="col-12 col-md-9">
          <LocalForm onSubmit={(value) => this.handleSubmit(value)}>
            ...
            <Row className="form-group">
              ...
              <Col md={10}>
                <Control type="tel" model=".telnum" id="telnum" name="telnum" placeholder="Contact Tel." className="form-control" 
                validators={{ 
                  required, isNumber
                }}
                />
            ...
            <Row className="form-group">
              ...
              <Col md={10}>
                <Control.textarea model=".message" id="message" name="message" rows="12" placeholder="Feedback" className="form-control" />
              </Col>
            </Row>
            <Row className="form-group">
